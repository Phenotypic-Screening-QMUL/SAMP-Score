...
combined_testData <- read.csv("Cell_Line_Z_Scores.csv")
...
write.csv(predicted_classes_DDU_Screen, "Predictions.csv")
...
Heatmap <- Heatmap_Data[,-c(2,3)]

rownames(Heatmap) <- Heatmap[,1]
Heatmap <- Heatmap[,-1]

all_matrix <- as.matrix(Heatmap)
...
write.csv(Heatmap_Data[,1:4], "Pred_Coeffs.csv")
